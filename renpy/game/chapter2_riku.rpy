...
label ev_riku4:
    ...
    if yuki_song_recovered:

        ## 独2「呼び水」(企画書2026-07-13): 言葉より先に、音楽が届く。
        "言葉は、届かなかった。何を話しかけても、返ってくるのは経典だけ。"
        ...
        "東京駅の雑踏で取り戻した、金賞の自由曲。最初の八小節が、地下室の空気を静かに割った。"

        "凛久の虚ろな目が——音のする方を、向いた。"

        rikuhisa "…………はしっちゃ、だめ、なとこ……"

        "楽譜の書き込みと、同じ言葉だった。"

        yuki "そう。りくちゃんが、いっつも走っちゃうとこ。……今度は、わたしが合わせるから。"
