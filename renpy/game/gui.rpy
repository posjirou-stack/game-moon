## 月夜が魅せる物語 GUI設定。Ren'Py 8.1.3 標準テンプレートをベースに、
## フォント(IPAゴシック)・配色(月夜テーマ)・背景(単色)を変更したもの。
...
define gui.muted_color = "#2a2440"
define gui.hover_muted_color = "#3d3560"
...
define gui.text_font = "fonts/ipag.ttf"

## The font used for character names.
define gui.name_text_font = "fonts/ipag.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "fonts/ipag.ttf"
...
define gui.main_menu_background = next((("images/bg/title" + e) for e in (".png", ".jpg", ".jpeg", ".webp") if renpy.loadable("images/bg/title" + e)), "#0d1128")
