...
style vbar:
    xsize gui.bar_size
    top_bar gui.muted_color
    bottom_bar gui.accent_color

style scrollbar:
    ysize gui.scrollbar_size
    base_bar "#2a244080"
    thumb gui.accent_color
...
style slider:
    ...
    base_bar gui.muted_color
    thumb Solid(gui.accent_color, xsize=26, ysize=gui.slider_size)

style vslider:
    xsize gui.slider_size
    base_bar gui.muted_color
    thumb Solid(gui.accent_color, xsize=gui.slider_size, ysize=26)
...
style namebox:
    ...
    background Frame(Solid("#241b3ce6"), gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("戻す") action Rollback()
...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("事件簿") action ShowMenu("casebook")
...
screen about():
    ...
    ## game_menu screen.
    use game_menu(_("クレジット"), scroll="viewport"):
...
screen history():
    ...
    use game_menu(_("履歴"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
